...
import net.sbscon.appauth.AuthorizationServiceDiscovery.MissingArgumentException;
import net.sbscon.appauth.IdToken.IdTokenException;
...
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_AUTHORIZATION_ENDPOINT;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_CLAIMS_SUPPORTED;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_END_SESSION_ENDPOINT;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_ID_TOKEN_SIGNING_ALG_VALUES;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_JWKS_URI;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_REGISTRATION_ENDPOINT;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_RESPONSE_TYPES_SUPPORTED;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_SCOPES_SUPPORTED;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_SUBJECT_TYPES_SUPPORTED;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_TOKEN_ENDPOINT;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_TOKEN_ENDPOINT_AUTH_METHODS;
import static net.sbscon.appauth.AuthorizationServiceDiscoveryTest.TEST_USERINFO_ENDPOINT;
import static net.sbscon.appauth.TestValues.TEST_APP_REDIRECT_URI;
import static net.sbscon.appauth.TestValues.TEST_AUTH_CODE;
import static net.sbscon.appauth.TestValues.TEST_CLIENT_ID;
import static net.sbscon.appauth.TestValues.TEST_CODE_VERIFIER;
import static net.sbscon.appauth.TestValues.TEST_ISSUER;
import static net.sbscon.appauth.TestValues.TEST_NONCE;
import static net.sbscon.appauth.TestValues.getDiscoveryDocumentJson;
import static net.sbscon.appauth.TestValues.getTestAuthCodeExchangeRequest;
import static net.sbscon.appauth.TestValues.getTestAuthCodeExchangeRequestBuilder;
