...
import net.sbscon.appauth.JsonUtil.BooleanField;
import net.sbscon.appauth.JsonUtil.Field;
import net.sbscon.appauth.JsonUtil.StringField;
import net.sbscon.appauth.JsonUtil.StringListField;
import net.sbscon.appauth.JsonUtil.UriField;
...
public class AuthorizationServiceDiscovery {
    ...
    public static class MissingArgumentException extends Exception {
        private final String mMissingField;
